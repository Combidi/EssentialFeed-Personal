//
//  Created by Peter Combee on 04/07/2022.
//
...
class CommentUIIntegrationTests: FeedUIIntegrationTests {
    ...
    func test_loadCommentsActions_requestCommentsFromLoader() {
        ...
        XCTAssertEqual(loader.loadCommentsCallCount, 2, "Expected another loading request once user initiates load")
