//
//  Created by Peter Combee on 09/01/2022.
//
...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        expect(sut, toReceive: .found(feed: latestFeed, timestamp: latestTimestamp))
    }
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected side-effects ro run serially but operations finished in the wrong order")
    }
    ...
    private func expect(_ sut: FeedStore, toReceiveTwice expectedResult: RetrieveCachedFeedResult, file: StaticString = #filePath, line: UInt = #line) {
        expect(sut, toReceive: expectedResult, file: file, line: line)
        expect(sut, toReceive: expectedResult, file: file, line: line)
    }
    
    private func expect(_ sut: FeedStore, toReceive expectedResult: RetrieveCachedFeedResult, file: StaticString = #filePath, line: UInt = #line) {
